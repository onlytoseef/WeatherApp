...
export default function SearchInput(props) {
   ...
   return (
      ...
      w-[311px] sm:w-[504px] h-14 pr-5 bg-[#1E1E29] rounded-lg justify-center items-center inline-flex 
      `}>
         <input
            ...
            type="text"
            name="city"
            class={`w-[311px] sm:w-[504px] px-5 bg-[#1E1E29] rounded-lg justify-center items-center inline-flex outline-none text-[#7F7F98]`}
         />
         {loadings ? (
            <svg
               width="32"
